...
ActiveRecord::Schema.define(version: 20161030045011) do
  ...
  create_table "ticket_details", force: :cascade do |t|
    ...
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
    t.index ["ticket_id"], name: "index_ticket_details_on_ticket_id", using: :btree
    t.index ["ticket_type_id"], name: "index_ticket_details_on_ticket_type_id", using: :btree
  end
  ...
  add_foreign_key "ticket_details", "ticket_types"
